...
public class ProductManager {
    ...
    public static void getProduct() {
        Product product1 = new Product(1, "IP8", 65, 9500000);
        Product product2 = new Product(2, "Sam sung Galaxy Note 12", 98, 12000000);
        Product product3 = new Product(3, "Redmi Note 8", 84, 9500000);
        Product product4 = new Product(4, "IP 13 Pro Max", 72, 32000000);
        Product product5 = new Product(5, "Nokia 1080", 41, 300000);
        Product product6 = new Product(6, "Macbook", 65, 9500000);
